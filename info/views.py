...
def project(request):  # О Проекте
    ...
    plan1['total'] = 60
    plan1['finished'] = 48.0
    plan1['progress'] = int(round(plan1['finished'] / plan1['total'] * 100, 0))

    plan3 = {}
    plan3['total'] = 5
    plan3['finished'] = 1.0
    plan3['progress'] = int(round(plan3['finished'] / plan3['total'] * 100, 0))

    return render_to_response('project.html', {'plan1': plan1, 'plan3': plan3},
